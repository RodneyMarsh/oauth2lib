...
class UtilsTest(unittest.TestCase):
    ...
    def test_build_url(self):
        ...
        self.assertEqual(result, 'https://www.myapp.com/some/path;hello?c=30&b=20&a=10')
